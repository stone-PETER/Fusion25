...
const About = () => {
  return (
    <div className="about-bg text-white p-8 text-center">
      <h2 className="font-RoverExplore text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-wide uppercase mb-6">
        ABOUT FUSION
      </h2>

      <p className="mt-10 text-base leading-relaxed font-ClashDisplay text-center max-w-2xl mx-auto mb-8">
      ...
      <img
        ...
        alt="Fusion Logo"
        className="mt-8 w-[200px] h-auto mx-auto block"
      />
    </div>
  );
};
